...
@author: jiler
Forked and updated by Brad Dial
"""
...
def process_json_xml(json_filename):
    class XmlNote:
    ...
    backup_filename = os.path.join(backup_dir, os.path.basename(json_filename) + '_bak.json')
    ...
    # Writing to the original filename
